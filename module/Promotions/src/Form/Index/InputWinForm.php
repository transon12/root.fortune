...
class InputWinForm extends Form{
    ...
    private function setElements(){
        ...
        $userId = new Element\Select('user_id');
        $userId->setLabel('Tài khoản fortune: ')
            ->setAttributes([
                'class' => 'form-control'
            ]);
        $this->add($userId);
        
        $userCrmId = new Element\Select('user_crm_id');
        $userCrmId->setLabel('Tài khoản CRM: ')
            ->setAttributes([
                'class' => 'form-control'
            ]);
        $this->add($userCrmId);
        
        $promotionsId = new Element\Select('promotion_id');
